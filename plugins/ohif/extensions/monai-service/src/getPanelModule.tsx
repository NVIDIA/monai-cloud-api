...
import MonaiServicePanel from './components/MonaiServicePanel';
...
function getPanelModule({
  ...
  const WrappedMonaiServicePanel = () => {
    return (
      <MonaiServicePanel
        commandsManager={commandsManager}
        servicesManager={servicesManager}
  ...
  return [
    {
      ...
      iconLabel: 'MONAI',
      label: 'MONAI Service',
      secondaryLabel: 'MONAI Service',
      component: WrappedMonaiServicePanel,
    },
  ];
}
